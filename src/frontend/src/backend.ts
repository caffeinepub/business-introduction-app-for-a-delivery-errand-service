...
export class Backend implements backendInterface {
    ...
    async getPagedRequests(arg0: bigint, arg1: bigint): Promise<Array<ContactRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPagedRequests(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRequestById(arg0: bigint): Promise<ContactRequest> {
        if (this.processError) {
            try {
    ...
    async getRequestCount(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getRequestCount();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRequestsByEmail(arg0: string): Promise<Array<ContactRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getRequestsByEmail(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
